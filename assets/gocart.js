        ...
        return (
          ...
          (e = [
            ...
            },
            {
              ...
              value: function (t) {
                var e = this;
                document.querySelector(".go-cart-drawer__progress-bar").classList.remove("hide"),
                document.querySelector(".go-cart-drawer__upsell").classList.remove("hide"),
                document.querySelector(".total-items").innerHTML = `(${t.item_count} items)`
                this.clearCartDrawer(),
                  t.items.forEach(function (t, r) {
                    ...
                    null === a && (a = "");
                    var o = `
                    <div class="go-cart-item__single" data-line="${Number(r + 1)}">
                        <div class="go-cart-item__info-wrapper">
                            ...
                            <div class="go-cart-item__info">
                                ...
                                ${t.options_with_values.map((opt)=>(
                                  `<div class="go-cart-item__variant">${opt.name}: <span>${opt.value.toLowerCase()}</span></div>`
                                )).join("")}
                        ...
                        <div class="go-cart-item__price">${priceHTML}</div>
                        <a class="go-cart-item__remove js-go-cart-remove-from-cart">Remove</a>
                    </div>
                    `;
            ...
            },
            {
              ...
              value: function () {
                this.cartDrawerSubTotal.parentNode.classList.add(
                  ...
                  this.clearCartDrawer(),
                  document.querySelector(".go-cart-drawer__progress-bar").classList.add("hide"),
